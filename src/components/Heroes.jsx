        ...
        <div className="relative h-[843px] lg:h-[640px] bg-peach md:rounded-[15px] pt-20 md:pt-[60px] lg:pt-0 px-7 lg:px-16 xl:px-24 overflow-hidden">
            ...
            <div className="lg:flex h-full lg:items-center">
                <section className='relative z-10 flex flex-col items-center justify-center lg:block text-center lg:text-left'>
                    ...
                    <p className='text-base leading-[26px] text-white mt-6 md:mt-8 lg:mt-8 mb-7 md:mb-5 lg:mb-10 max-w-[415px] md:max-w-full lg:w-[440px]'>With over 10 years in the industry, we are experienced in creating fully responsive websites, app design, and engaging brand experiences. Find out more about our services.</p>
